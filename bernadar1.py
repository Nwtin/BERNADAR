...
def gen_markup():
    ...
    markup.add(InlineKeyboardButton(
        ...
        ,InlineKeyboardButton("BUSCA VIZINHOS", callback_data="cb_vizinhos")
...
def callback_query(call):
    if call.data == "cb_yes":
        ...
        return bot.edit_message_text("CONSULTA VIZINHOS /VIZINHOS", call.message.chat.id, call.message.message_id)
