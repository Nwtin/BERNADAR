...
bot = telebot.TeleBot("1816092880:AAFzSxaurkDATEczNM1MuhAEa_ywvbN243g")
...
def gen_markup():
    ...
    markup.row_width = 2
    markup.add(InlineKeyboardButton("COMANDOS VIPS", callback_data="cb_yes"),
...
def callback_query(call):
    if call.data == "cb_yes":
        bot.send_message(call.message.chat.id, "🚫MENU DO BOT🚫 : /CPF1 , /PLACA, /VIZINHOS , /CNPJ")
    elif call.data == "cb_no":
        bot.send_message(call.message.chat.id, "NENHUM NO MOMENTO")
